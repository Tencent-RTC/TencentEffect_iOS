...
(function () {
    ...
    template.uniformJson = {
        "uniformMap": {
            "green_seg_chromakey": {
                "green_params": [0.3, 1.0, 1.0, 0.0], // [similarity, deshadow, corrosion,color]
                "tex_rect": [0.0, 0.0, 720.0, 1280.0],
                "average_green": [0.0, 1.0, 0.0, 0.0]
            },
            "Corrosion": {
                "tex_rect": [0.0, 0.0, 720.0, 1280.0],
                "corrosion": [1.0, 0.0, 0.0, 0.0] // [corrosion,color]
            },
            "green_seg_merge": {
                "tex_rect": [0.0, 0.0, 720.0, 1280.0],
                "merge_params": [1.0, 0.3, 0.2, 0.7], // [corrosion, despill, smooth, blendWeight]
...
//    // 订阅InputEvent事件
    template.onInputEvent = function(params) {
        ...
        if (GreenSeg_jsonDataParams) {
            ...
            var color_value = 0.0;//0.0表示绿幕，1.0表示蓝幕
